...
const FEATURES = [
  ...
  { href: "/qibla" as const, title: "Qibla", subtitle: "Find the direction", icon: "compass-outline", tone: "amber" },
  ...
  return (
    <ScreenContainer className="px-0 py-0">
      <ScrollView className="flex-1" contentContainerClassName="px-6 py-6" showsVerticalScrollIndicator={false}>
        <Text className="text-sm font-medium text-brand-600">Assalamu Alaikum</Text>
        <Text className="mt-1 text-3xl font-semibold text-slate-900">Welcome to Ummah</Text>
        <Text className="mt-2 text-base text-slate-600">Everything for your daily worship, in one place.</Text>
